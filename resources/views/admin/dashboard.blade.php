...
<body class="bg-white font-poppins leading-normal tracking-normal">
    <div class="flex">
        <!-- Sidebar -->
        <div class="hidden md:block sidebar-shrink bg-[#1e3a8a] h-screen shadow-md transition-all duration-300"
            id="sidebar">
            <div class="pt-7 p-5">
        ...
        <div class="flex-1 ">
            ...
            <nav class="flex justify-between items-center mb-10 p-6 rounded shadow bg-white">
                <div class="flex items-center">
                    ...
                    <h2 class="font-bold ml-4 md:text-2xl text-black">Dashboard Pembina</h2>
                </div>
                <div class="relative">
