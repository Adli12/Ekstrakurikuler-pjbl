<div class="fixed -translate-x-full md:translate-x-0 left-0 top-0 w-64 bg-[#1e3a8a] h-screen shadow-lg transform transition-all duration-300 z-10 md:relative md:w-60 overflow-y-auto"
    id="sidebar">
